...
class TestCart(TestCase):
    ...
    def test_add_product_to_cart(self):
        ...
        self.cart.add_product_to_cart(1, 1, 1)
        self.assertTrue(self.cart.basket_dict[1].products_dict[1] == 2)
        self.cart.add_product_to_cart(1, 2, 1)
        self.assertTrue(self.cart.basket_dict[1].products_dict[2] == 1)
        self.cart.add_product_to_cart(2, 2, 2)
        self.assertTrue(self.cart.basket_dict[2].products_dict[2] == 2)
    ...
    def test_remove_product_from_cart(self):
        ...
        self.assertTrue(self.cart.basket_dict[1].products_dict[1] == 1)
        self.cart.remove_product_from_cart(1, 1, 1)
        self.assertRaises(Exception, self.cart.remove_product_from_cart, 1, 1, 1)
        self.cart.add_product_to_cart(2, 2, 2)
        self.cart.remove_product_from_cart(2, 2, 1)
        self.assertTrue(self.cart.basket_dict[2].products_dict[2] == 1)
