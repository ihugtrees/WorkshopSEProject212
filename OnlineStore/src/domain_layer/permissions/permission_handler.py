...
class PermissionHandler:
    ...
    def set_permissions(self, new_permissions: int, user_name: str, store_name: str) -> None:
        # permissions.get_permissions_by_user_name(user_name).set_permissions(new_permissions, store_name) #TODO MAYBE REMOVE WORK WITH RAM
        permissions.set_permmisions(new_permissions, user_name, store_name)
